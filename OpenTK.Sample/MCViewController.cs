    ...
    public class MCViewController : GLKViewController
    {
        ...
        public override void Update()
        {
            ...
            Matrix4x4 projectionMatrix =
                Matrix4x4.CreatePerspectiveFieldOfView((float)(Math.PI * 65f / 180.0f),
                                                      aspect, 0.1f, 100.0f);

            effect.Transform.ProjectionMatrix = projectionMatrix;
            skyboxEffect.Transform.ProjectionMatrix = projectionMatrix;

            Matrix4x4 modelViewMatrix = Matrix4x4.CreateTranslation(new System.Numerics.Vector3(0f, 0f, -3.5f));
            modelViewMatrix = Matrix4x4.Multiply(Matrix4x4.CreateFromAxisAngle(new Vector3(1f, 1f, 1f), rotation), modelViewMatrix);
            
            effect.Transform.ModelViewMatrix = modelViewMatrix;

            modelViewMatrix = Matrix4x4.Multiply(Matrix4x4.CreateScale(50f), modelViewMatrix);
