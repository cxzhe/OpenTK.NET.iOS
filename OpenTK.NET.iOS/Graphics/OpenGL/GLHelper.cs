...
#pragma warning disable 1573
        ...
        public static void Color3(NVector3 color)
        {
        ...
        public static void Normal3(NVector3 normal)
        {
        ...
        public static void RasterPos3(NVector3 pos)
        {
        ...
        public static void Vertex3(NVector3 v)
        {
        ...
        public static void TexCoord3(NVector3 v)
        {
        ...
        public static void Rotate(Single angle, NVector3 axis)
        {
            GL.Rotate((Single)angle, axis.X, axis.Y, axis.Z);
        }

        public static void Scale(NVector3 scale)
        {
            GL.Scale(scale.X, scale.Y, scale.Z);
        }

        public static void Translate(NVector3 trans)
        {
            GL.Translate(trans.X, trans.Y, trans.Z);
        }

        public static void MultMatrix(ref NMatrix4 mat)
        {
            unsafe
            {
        ...
        public static void LoadMatrix(ref NMatrix4 mat)
        {
            unsafe
            {
                fixed (Single* m_ptr = &mat.M11)
        ...
        public static void LoadTransposeMatrix(ref NMatrix4 mat)
        {
            unsafe
            {
                fixed (Single* m_ptr = &mat.M11)
        ...
        public static void MultTransposeMatrix(ref NMatrix4 mat)
        {
            unsafe
            {
                fixed (Single* m_ptr = &mat.M11)
        ...
        public static void UniformMatrix4(int location, bool transpose, ref NMatrix4 matrix)
        {
            unsafe
            {
        ...
        public static void Normal3(NVector3d normal)
        {
            GL.Normal3(normal.X, normal.Y, normal.Z);
        }

        public static void RasterPos2(NVector2d pos)
        {
            GL.RasterPos2(pos.X, pos.Y);
        }

        public static void RasterPos3(NVector3d pos)
        {
            GL.RasterPos3(pos.X, pos.Y, pos.Z);
        }

        public static void RasterPos4(NVector4d pos)
        {
            GL.RasterPos4(pos.X, pos.Y, pos.Z, pos.W);
        }

        public static void Vertex2(NVector2d v)
        {
            GL.Vertex2(v.X, v.Y);
        }

        public static void Vertex3(NVector3d v)
        {
            GL.Vertex3(v.X, v.Y, v.Z);
        }

        public static void Vertex4(NVector4d v)
        {
            GL.Vertex4(v.X, v.Y, v.Z, v.W);
        }

        public static void TexCoord2(NVector2d v)
        {
            GL.TexCoord2(v.X, v.Y);
        }

        public static void TexCoord3(NVector3d v)
        {
            GL.TexCoord3(v.X, v.Y, v.Z);
        }

        public static void TexCoord4(NVector4d v)
        {
            GL.TexCoord4(v.X, v.Y, v.Z, v.W);
        }

        public static void Rotate(double angle, NVector3d axis)
        {
            GL.Rotate((double)angle, axis.X, axis.Y, axis.Z);
        }

        public static void Scale(NVector3d scale)
        {
            GL.Scale(scale.X, scale.Y, scale.Z);
        }

        public static void Translate(NVector3d trans)
        {
            GL.Translate(trans.X, trans.Y, trans.Z);
        }

        public static void MultMatrix(ref NMatrix4d mat)
        {
            unsafe
            {
                fixed (Double* m_ptr = &mat.M11)
                {
        ...
        public static void LoadMatrix(ref NMatrix4d mat)
        {
            unsafe
            {
                fixed (Double* m_ptr = &mat.M11)
        ...
        public static void LoadTransposeMatrix(ref NMatrix4d mat)
        {
            unsafe
            {
                fixed (Double* m_ptr = &mat.M11)
        ...
        public static void MultTransposeMatrix(ref NMatrix4d mat)
        {
            unsafe
            {
                fixed (Double* m_ptr = &mat.M11)
        ...
        [CLSCompliant(false)]
        public static void Uniform3(int location, ref NVector3 vector)
        {
        ...
        public static void Uniform3(int location, NVector3 vector)
        {
            GL.Uniform3(location, vector.X, vector.Y, vector.Z);
        }
        ...
        [CLSCompliant(false)]
        public static void VertexAttrib3(Int32 index, ref NVector3 v)
        {
        ...
        public static void VertexAttrib3(Int32 index, NVector3 v)
        {
            GL.VertexAttrib3(index, v.X, v.Y, v.Z);
        }
        ...
        public static void MultiTexCoord3(TextureUnit target, ref NVector3 v)
        {
        ...
        [CLSCompliant(false)]
        public static void VertexAttrib2(Int32 index, ref NVector2d v)
        {
            GL.VertexAttrib2(index, v.X, v.Y);
        }

        [CLSCompliant(false)]
        public static void VertexAttrib3(Int32 index, ref NVector3d v)
        {
            GL.VertexAttrib3(index, v.X, v.Y, v.Z);
        }

        [CLSCompliant(false)]
        public static void VertexAttrib4(Int32 index, ref NVector4d v)
        {
            GL.VertexAttrib4(index, v.X, v.Y, v.Z, v.W);
        }

        public static void VertexAttrib2(Int32 index, NVector2d v)
        {
            GL.VertexAttrib2(index, v.X, v.Y);
        }

        public static void VertexAttrib3(Int32 index, NVector3d v)
        {
            GL.VertexAttrib3(index, v.X, v.Y, v.Z);
        }

        public static void VertexAttrib4(Int32 index, NVector4d v)
        {
            GL.VertexAttrib4(index, v.X, v.Y, v.Z, v.W);
        }

        public static void MultiTexCoord2(TextureUnit target, ref NVector2d v)
        {
            GL.MultiTexCoord2(target, v.X, v.Y);
        }

        public static void MultiTexCoord3(TextureUnit target, ref NVector3d v)
        {
            GL.MultiTexCoord3(target, v.X, v.Y, v.Z);
        }

        public static void MultiTexCoord4(TextureUnit target, ref NVector4d v)
        {
            GL.MultiTexCoord4(target, v.X, v.Y, v.Z, v.W);
        }
        ...
        public static void GetFloat(GetPName pname, out NVector3 vector)
        {
            unsafe
            {
                fixed (NVector3* ptr = &vector)
                    GetFloat(pname, (float*)ptr);
            }
        }
        ...
        public static void GetFloat(GetPName pname, out NMatrix4 matrix)
        {
            unsafe
            {
                fixed (NMatrix4* ptr = &matrix)
                    GetFloat(pname, (float*)ptr);
            }
        }

        public static void GetDouble(GetPName pname, out NVector2d vector)
        {
            unsafe
            {
                fixed (NVector2d* ptr = &vector)
                    GetDouble(pname, (double*)ptr);
            }
        }

        public static void GetDouble(GetPName pname, out NVector3d vector)
        {
            unsafe
            {
                fixed (NVector3d* ptr = &vector)
                    GetDouble(pname, (double*)ptr);
            }
        }

        public static void GetDouble(GetPName pname, out NVector4d vector)
        {
            unsafe
            {
                fixed (NVector4d* ptr = &vector)
                    GetDouble(pname, (double*)ptr);
            }
        }

        public static void GetDouble(GetPName pname, out NMatrix4d matrix)
        {
            unsafe
            {
                fixed (NMatrix4d* ptr = &matrix)
                    GetDouble(pname, (double*)ptr);
            }
        }
